...
╭──➭ \33[33m RAPID v1.00-beta2-rc1 \33[0m
├─➭ \33[1;97;100m ᴘᴀɴᴇʟᴘᴏʀᴛ ➭ """+str(panel)+""" \33[0m
├─➭ """+tokenr+str(mac)+"""  \33[0m\33[1;4;94mCPM➭"""+str(cpm)+""" \33[0m 
├──➭ \33[1;30m Bot"""+str(bot)+"""  \33[36mTotal➭"""+str(total)+"""  \33[0m"""+str(hitr)+"""HIT➭""" +str(hitc)+"""   \33[0m \33[1;31m%"""+str(oran)+"""  \33[0m
...
╭⏩RAPID MULTISCANNER V1.00beta2-rc1
...
├⏩𝗩𝗽𝗻 """+str(vpn)+"""    """+str(playerapi)+""" """
		...
		if  kanalkata=="1" or kanalkata=="2":
			imza=imza+"""
├⏩LIVE TV CHANNELS"""+str(livelist)+""" 
├⏩𝗺3u (if available): """+str(m3ulink)+"""
"""
