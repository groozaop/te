...
print ("""Escolha o numero do seu combo
	
 """+dsy+"""
 
\33[33mCombos Encontrado """ +str(say)+""" Aproveitar!!!
""")
...
print(dosyaa) 
botsay=input("""
   \33[1;96mEscolha a quantidade de Bots 1 a 15...!!!\33[0m
    \33[1;33mMaximo 15...!
      Faz o atake amor !!!\33[0m
...
#################
panel = input("""
	\33[1mQual servidor voce deseja fazer o atake ? \n\n
...
def echox(user,pas,bot,fyz,oran,hit):
	...
	echo=("""
\33[0m╭───➤\33[0m 𝗦𝗽𝗲𝗲𝗱 𝗫💙💙💙 TELEGRAM:@MESTREAPK    
